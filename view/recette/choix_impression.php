...
<div id="precision_fonction">
    ...
    <li><a href="#" onclick="window.print()">FT SANS PRIX</li>
    <li><?php echo '<a href="index.php?action=impressionfiche&controller=recette&idRecette=' . rawurlencode($r->getIdRecette()) . '"> FT avec Prix</a>'; ?></li>
    </ul>
