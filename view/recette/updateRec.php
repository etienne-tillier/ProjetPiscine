...
<script type="text/javascript" defer>
    ...
    function genererSelectUpdate() {
            ...
            <?php foreach ($listeRecette as $recette){?>
                ...
                <?php };?>
            $("#listeIngredient div:last").append("<li><input type='text' value='<?= $recetteDansRecette->getQuantiteRecette() ?>' name='quantitesRecettes[]' placeholder='Quantité recette' required></input></li>");
