...
<form method="get" action="index.php" controller="typeingredient">
    <fieldset>
        ...
        <p>
            ...
            <input type="text" placeholder="Ex : Fruits" name="nomTypeIngredient" <?= ($create ? "required" : "required") ?> value="<?= ($create ? htmlspecialchars($nomTypeIngredient) : "") ?>" id="nom_type_ingredient"/>
        </p>
